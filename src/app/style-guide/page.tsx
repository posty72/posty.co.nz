    ...
    >
      <div className="style-guide">
        <StyleGuideSection title="Colours" contain>
          ...
          <div className="style-guide-swatches" role="group">
            <Swatch title="Primary Gradient" value="gradient-standard" />
            <Swatch title="Secondary Gradient" value="gradient-secondary" />
            <Swatch title="Tertiary Gradient" value="gradient-tertiary" />
          </div>
        </StyleGuideSection>
        ...
        <StyleGuideSection title="Type" contain>
          <Content>
            ...
            <p>
              ...
              Magni dicta provident aliquam aut, laboriosam maxime, autem nemo
              voluptate iusto voluptas odio facilis perferendis quod a
              <strong> reprehenderit tempora</strong> accusantium commodi
              eveniet?
            </p>
            {/* <!--cSpell:enable --> */}
            ...
            <ul>
              <li>
                Lorem Khalid Ipsum is a major key to success. They never said
                winning was easy. Some people can’t handle success.
              </li>
              <li>
                A major key, never panic. Don’t panic, when it gets crazy and
                rough, don’t panic, stay calm.
              </li>{" "}
              <li>
                In life you have to take the trash out, if you have trash in
                your life, take it out, throw it away, get rid of it, major key
              </li>
              <li>
                The weather is amazing, walk with me through the pathway of more
                success. Take this journey with me, Lion! Learning is cool, but
                knowing is better, and I know the key to success. Elliptical
                talk.
              </li>
            </ul>
            <h5>Ordered List</h5>
        ...
        <StyleGuideSection title="Highlight Box">
          <Highlight title="Hello">
            ...
            <p>
              ...
              Voluptates explicabo odit, quibusdam incidunt nemo, fuga eos
              reiciendis enim et deleniti pariatur. Praesentium at velit aperiam
              dicta pariatur architecto molestiae soluta.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptates explicabo odit, quibusdam incidunt nemo, fuga eos
